...
const HomePage = ({ mode, lang, t, navigate, setLang, startMatrix, setTheme }) => {
  ...
  return (
    <div>
      {mode === 'dev' ? (
        <Suspense fallback={<section className="hero-terminal"></section>}>
        ...
        <section className="hero stagger">
          ...
          <div className="cta-group">
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg> {t('btn-contact')}
            </a>
          </div>
